package gr.aueb.cf.colorfulnotesapp.activities;
...
import gr.aueb.cf.colorfulnotesapp.MainActivity;
import gr.aueb.cf.colorfulnotesapp.R;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int color = ContextCompat.getColor(this, R.color.head);
